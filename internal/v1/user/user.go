...
type Request struct {
	...
	PilotRating      constants.PilotRating `json:"pilot_rating" example:"1" validate:"required"`
	ControllerRating constants.ATCRating   `json:"controller_rating" example:"1" validate:"required"`
